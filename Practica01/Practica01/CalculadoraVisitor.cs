...
{
    internal class CalculadoraVisitor : CalculadoraBaseVisitor<double>
    {
        /*public override double VisitCompileUnit(CalculadoraParser.CompileUnitContext context)
        {
            return Visit(context.expr());
        }

        public override double VisitExpr(CalculadoraParser.ExprContext context)
        {
